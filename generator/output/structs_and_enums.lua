local t={
  ...
  enumtypes={},
  locations={
    Formatter_Time_Data="implot_internal:1648",
    ImAxis_="implot:116",
    ...
    ImPlotAxisFlags_="implot:145",
    ImPlotBarGroupsFlags_="implot:263",
    ImPlotBarsFlags_="implot:257",
    ImPlotBin_="implot:459",
    ImPlotCol_="implot:340",
    ImPlotColormapData="implot_internal:319",
    ImPlotColormapScaleFlags_="implot:214",

local t={
  ...
  ImPlot_PlotImage={
    [1]={
      args="(const char* label_id,ImTextureRef tex_ref,const ImPlotPoint bounds_min,const ImPlotPoint bounds_max,const ImVec2 uv0,const ImVec2 uv1,const ImVec4 tint_col,ImPlotImageFlags flags)",
      argsT={
        [1]={
          name="label_id",
          type="const char*"},
      ...
      call_args="(label_id,tex_ref,bounds_min,bounds_max,uv0,uv1,tint_col,flags)",

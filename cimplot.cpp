...
CIMGUI_API void ImPlot_ColormapScale(const char* label,double scale_min,double scale_max,const ImVec2 size,ImPlotColormap cmap)
{
    return ImPlot::ColormapScale(label,scale_min,scale_max,size,cmap);
}

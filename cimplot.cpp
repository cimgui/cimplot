...
//based on implot.h file version 0.13 WIP from implot https://github.com/epezent/implot
...
CIMGUI_API void ImPlot_PlotStairsG(const char* label_id,ImPlotGetter getter,void* data,int count)
{
    return ImPlot::PlotStairsG(label_id,getter,data,count);
}
CIMGUI_API void ImPlot_PlotShaded_FloatPtrInt(const char* label_id,const float* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_doublePtrInt(const char* label_id,const double* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_S8PtrInt(const char* label_id,const ImS8* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_U8PtrInt(const char* label_id,const ImU8* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_S16PtrInt(const char* label_id,const ImS16* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_U16PtrInt(const char* label_id,const ImU16* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_S32PtrInt(const char* label_id,const ImS32* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_U32PtrInt(const char* label_id,const ImU32* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_S64PtrInt(const char* label_id,const ImS64* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_U64PtrInt(const char* label_id,const ImU64* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_FloatPtrFloatPtrInt(const char* label_id,const float* xs,const float* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_doublePtrdoublePtrInt(const char* label_id,const double* xs,const double* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_S8PtrS8PtrInt(const char* label_id,const ImS8* xs,const ImS8* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_U8PtrU8PtrInt(const char* label_id,const ImU8* xs,const ImU8* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_S16PtrS16PtrInt(const char* label_id,const ImS16* xs,const ImS16* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_U16PtrU16PtrInt(const char* label_id,const ImU16* xs,const ImU16* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_S32PtrS32PtrInt(const char* label_id,const ImS32* xs,const ImS32* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_U32PtrU32PtrInt(const char* label_id,const ImU32* xs,const ImU32* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_S64PtrS64PtrInt(const char* label_id,const ImS64* xs,const ImS64* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotShaded_U64PtrU64PtrInt(const char* label_id,const ImU64* xs,const ImU64* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotShaded(label_id,xs,ys,count,yref,offset,stride);
}
...
CIMGUI_API void ImPlot_PlotBars_FloatPtrInt(const char* label_id,const float* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_doublePtrInt(const char* label_id,const double* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_S8PtrInt(const char* label_id,const ImS8* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_U8PtrInt(const char* label_id,const ImU8* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_S16PtrInt(const char* label_id,const ImS16* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_U16PtrInt(const char* label_id,const ImU16* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_S32PtrInt(const char* label_id,const ImS32* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_U32PtrInt(const char* label_id,const ImU32* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_S64PtrInt(const char* label_id,const ImS64* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_U64PtrInt(const char* label_id,const ImU64* values,int count,double bar_width,double x0,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,values,count,bar_width,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_FloatPtrFloatPtr(const char* label_id,const float* xs,const float* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_doublePtrdoublePtr(const char* label_id,const double* xs,const double* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_S8PtrS8Ptr(const char* label_id,const ImS8* xs,const ImS8* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_U8PtrU8Ptr(const char* label_id,const ImU8* xs,const ImU8* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_S16PtrS16Ptr(const char* label_id,const ImS16* xs,const ImS16* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_U16PtrU16Ptr(const char* label_id,const ImU16* xs,const ImU16* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_S32PtrS32Ptr(const char* label_id,const ImS32* xs,const ImS32* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_U32PtrU32Ptr(const char* label_id,const ImU32* xs,const ImU32* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_S64PtrS64Ptr(const char* label_id,const ImS64* xs,const ImS64* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBars_U64PtrU64Ptr(const char* label_id,const ImU64* xs,const ImU64* ys,int count,double bar_width,int offset,int stride)
{
    return ImPlot::PlotBars(label_id,xs,ys,count,bar_width,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_FloatPtrInt(const char* label_id,const float* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_doublePtrInt(const char* label_id,const double* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_S8PtrInt(const char* label_id,const ImS8* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_U8PtrInt(const char* label_id,const ImU8* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_S16PtrInt(const char* label_id,const ImS16* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_U16PtrInt(const char* label_id,const ImU16* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_S32PtrInt(const char* label_id,const ImS32* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_U32PtrInt(const char* label_id,const ImU32* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_S64PtrInt(const char* label_id,const ImS64* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_U64PtrInt(const char* label_id,const ImU64* values,int count,double bar_height,double y0,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,values,count,bar_height,y0,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_FloatPtrFloatPtr(const char* label_id,const float* xs,const float* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_doublePtrdoublePtr(const char* label_id,const double* xs,const double* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_S8PtrS8Ptr(const char* label_id,const ImS8* xs,const ImS8* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_U8PtrU8Ptr(const char* label_id,const ImU8* xs,const ImU8* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_S16PtrS16Ptr(const char* label_id,const ImS16* xs,const ImS16* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_U16PtrU16Ptr(const char* label_id,const ImU16* xs,const ImU16* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_S32PtrS32Ptr(const char* label_id,const ImS32* xs,const ImS32* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_U32PtrU32Ptr(const char* label_id,const ImU32* xs,const ImU32* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_S64PtrS64Ptr(const char* label_id,const ImS64* xs,const ImS64* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarsH_U64PtrU64Ptr(const char* label_id,const ImU64* xs,const ImU64* ys,int count,double bar_height,int offset,int stride)
{
    return ImPlot::PlotBarsH(label_id,xs,ys,count,bar_height,offset,stride);
}
CIMGUI_API void ImPlot_PlotBarGroups_FloatPtr(const char* const label_ids[],const float* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_doublePtr(const char* const label_ids[],const double* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_S8Ptr(const char* const label_ids[],const ImS8* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_U8Ptr(const char* const label_ids[],const ImU8* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_S16Ptr(const char* const label_ids[],const ImS16* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_U16Ptr(const char* const label_ids[],const ImU16* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_S32Ptr(const char* const label_ids[],const ImS32* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_U32Ptr(const char* const label_ids[],const ImU32* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_S64Ptr(const char* const label_ids[],const ImS64* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroups_U64Ptr(const char* const label_ids[],const ImU64* values,int item_count,int group_count,double group_width,double x0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroups(label_ids,values,item_count,group_count,group_width,x0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_FloatPtr(const char* const label_ids[],const float* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_doublePtr(const char* const label_ids[],const double* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_S8Ptr(const char* const label_ids[],const ImS8* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_U8Ptr(const char* const label_ids[],const ImU8* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_S16Ptr(const char* const label_ids[],const ImS16* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_U16Ptr(const char* const label_ids[],const ImU16* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_S32Ptr(const char* const label_ids[],const ImS32* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_U32Ptr(const char* const label_ids[],const ImU32* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_S64Ptr(const char* const label_ids[],const ImS64* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
CIMGUI_API void ImPlot_PlotBarGroupsH_U64Ptr(const char* const label_ids[],const ImU64* values,int item_count,int group_count,double group_height,double y0,ImPlotBarGroupsFlags flags)
{
    return ImPlot::PlotBarGroupsH(label_ids,values,item_count,group_count,group_height,y0,flags);
}
...
CIMGUI_API void ImPlot_PlotStems_FloatPtrInt(const char* label_id,const float* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_doublePtrInt(const char* label_id,const double* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_S8PtrInt(const char* label_id,const ImS8* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_U8PtrInt(const char* label_id,const ImU8* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_S16PtrInt(const char* label_id,const ImS16* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_U16PtrInt(const char* label_id,const ImU16* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_S32PtrInt(const char* label_id,const ImS32* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_U32PtrInt(const char* label_id,const ImU32* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_S64PtrInt(const char* label_id,const ImS64* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_U64PtrInt(const char* label_id,const ImU64* values,int count,double yref,double xscale,double x0,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,values,count,yref,xscale,x0,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_FloatPtrFloatPtr(const char* label_id,const float* xs,const float* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_doublePtrdoublePtr(const char* label_id,const double* xs,const double* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_S8PtrS8Ptr(const char* label_id,const ImS8* xs,const ImS8* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_U8PtrU8Ptr(const char* label_id,const ImU8* xs,const ImU8* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_S16PtrS16Ptr(const char* label_id,const ImS16* xs,const ImS16* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_U16PtrU16Ptr(const char* label_id,const ImU16* xs,const ImU16* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_S32PtrS32Ptr(const char* label_id,const ImS32* xs,const ImS32* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_U32PtrU32Ptr(const char* label_id,const ImU32* xs,const ImU32* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_S64PtrS64Ptr(const char* label_id,const ImS64* xs,const ImS64* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
CIMGUI_API void ImPlot_PlotStems_U64PtrU64Ptr(const char* label_id,const ImU64* xs,const ImU64* ys,int count,double yref,int offset,int stride)
{
    return ImPlot::PlotStems(label_id,xs,ys,count,yref,offset,stride);
}
...
CIMGUI_API double ImPlot_PlotHistogram2D_FloatPtr(const char* label_id,const float* xs,const float* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_doublePtr(const char* label_id,const double* xs,const double* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_S8Ptr(const char* label_id,const ImS8* xs,const ImS8* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_U8Ptr(const char* label_id,const ImU8* xs,const ImU8* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_S16Ptr(const char* label_id,const ImS16* xs,const ImS16* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_U16Ptr(const char* label_id,const ImU16* xs,const ImU16* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_S32Ptr(const char* label_id,const ImS32* xs,const ImS32* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_U32Ptr(const char* label_id,const ImU32* xs,const ImU32* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_S64Ptr(const char* label_id,const ImS64* xs,const ImS64* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
CIMGUI_API double ImPlot_PlotHistogram2D_U64Ptr(const char* label_id,const ImU64* xs,const ImU64* ys,int count,int x_bins,int y_bins,bool density,ImPlotRect range,bool outliers)
{
    return ImPlot::PlotHistogram2D(label_id,xs,ys,count,x_bins,y_bins,density,range,outliers);
}
...
CIMGUI_API void ImPlot_Annotation_Bool(double x,double y,const ImVec4 color,const ImVec2 pix_offset,bool clamp,bool round)
{
    return ImPlot::Annotation(x,y,color,pix_offset,clamp,round);
}
CIMGUI_API void ImPlot_Annotation_Str(double x,double y,const ImVec4 color,const ImVec2 pix_offset,bool clamp,const char* fmt,...)
{
    va_list args;
    va_start(args, fmt);
    ImPlot::AnnotationV(x,y,color,pix_offset,clamp,fmt,args);
    va_end(args);
}
CIMGUI_API void ImPlot_AnnotationV(double x,double y,const ImVec4 color,const ImVec2 pix_offset,bool clamp,const char* fmt,va_list args)
{
    return ImPlot::AnnotationV(x,y,color,pix_offset,clamp,fmt,args);
}
CIMGUI_API void ImPlot_TagX_Bool(double x,const ImVec4 color,bool round)
{
    return ImPlot::TagX(x,color,round);
}
CIMGUI_API void ImPlot_TagX_Str(double x,const ImVec4 color,const char* fmt,...)
{
    va_list args;
    va_start(args, fmt);
    ImPlot::TagXV(x,color,fmt,args);
    va_end(args);
}
CIMGUI_API void ImPlot_TagXV(double x,const ImVec4 color,const char* fmt,va_list args)
{
    return ImPlot::TagXV(x,color,fmt,args);
}
CIMGUI_API void ImPlot_TagY_Bool(double y,const ImVec4 color,bool round)
{
    return ImPlot::TagY(y,color,round);
}
CIMGUI_API void ImPlot_TagY_Str(double y,const ImVec4 color,const char* fmt,...)
{
    va_list args;
    va_start(args, fmt);
    ImPlot::TagYV(y,color,fmt,args);
    va_end(args);
}
CIMGUI_API void ImPlot_TagYV(double y,const ImVec4 color,const char* fmt,va_list args)
{
    return ImPlot::TagYV(y,color,fmt,args);
}
...
CIMGUI_API void ImPlot_ColormapScale(const char* label,double scale_min,double scale_max,const ImVec2 size,ImPlotColormap cmap,const char* format)
{
    return ImPlot::ColormapScale(label,scale_min,scale_max,size,cmap,format);
}
...
CIMGUI_API const ImPlotTick* ImPlotTickCollection_Append_double(ImPlotTickCollection* self,double value,bool major,bool show_label,ImPlotFormatter formatter,void* data)
{
    return &self->Append(value,major,show_label,formatter,data);
}
CIMGUI_API const char* ImPlotTickCollection_GetText(ImPlotTickCollection* self,int idx)
{
    return self->GetText(idx);
}
CIMGUI_API void ImPlotTickCollection_OverrideSize(ImPlotTickCollection* self,const ImVec2 size)
{
    return self->OverrideSize(size);
}
CIMGUI_API void ImPlotTickCollection_OverrideSizeLate(ImPlotTickCollection* self,const ImVec2 size)
{
...
CIMGUI_API void ImPlot_AddTicksDefault(const ImPlotRange range,float pix,bool vertical,ImPlotTickCollection* ticks,ImPlotFormatter formatter,void* data)
{
    return ImPlot::AddTicksDefault(range,pix,vertical,*ticks,formatter,data);
}
CIMGUI_API void ImPlot_AddTicksLogarithmic(const ImPlotRange range,float pix,bool vertical,ImPlotTickCollection* ticks,ImPlotFormatter formatter,void* data)
{
    return ImPlot::AddTicksLogarithmic(range,pix,vertical,*ticks,formatter,data);
}
CIMGUI_API void ImPlot_AddTicksCustom(const double* values,const char* const labels[],int n,ImPlotTickCollection* ticks,ImPlotFormatter formatter,void* data)
{
    return ImPlot::AddTicksCustom(values,labels,n,*ticks,formatter,data);
}
